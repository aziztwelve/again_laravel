...
class CDEKController extends Controller
{
    ...
    public function saveSettings(Request $request)
    {
        $data = $request->validate([
            ...
            'settings.services.fitting' => ['boolean'],
            'settings.services.partial_delivery' => ['boolean'],
            'settings.services.no_inspection' => ['boolean'],
            'settings.cod_pickup_only' => ['boolean'],
            'settings.declared' => ['nullable', 'array'],
            'settings.declared.percent' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'settings.declared.value' => ['nullable', 'numeric', 'min:0'],
            'settings.price_rules' => ['nullable', 'array'],
            'settings.price_rules.threshold' => ['nullable', 'numeric', 'min:0'],
            'settings.price_rules.add_cost' => ['nullable', 'numeric', 'min:0'],
            'settings.price_rules.add_rko' => ['nullable', 'numeric', 'min:0'],
            'settings.price_rules.add_drc' => ['nullable', 'numeric', 'min:0'],
            'settings.price_rules.add_drc_adv' => ['nullable', 'numeric', 'min:0'],
            'settings.price_rules.rounded' => ['nullable', 'in:0,1,2'],
            'settings.tariff_display' => ['nullable', 'array'],
            'settings.experimental' => ['nullable', 'array'],
